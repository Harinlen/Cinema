...
KNSaoStyle *KNSaoStyle::ins=nullptr;

KNSaoStyle::KNSaoStyle() :
    QCommonStyle(),
    m_slideLeft(QPixmap(":/arrow_left.png")),
    m_slideRight(QPixmap(":/arrow_right.png")),
    m_slideUp(QPixmap(":/arrow_up.png")),
    m_slideDown(QPixmap(":/arrow_down.png")),
...
KNSaoStyle *KNSaoStyle::instance()
{
    ...
    return ins==nullptr?ins=new KNSaoStyle:ins;
}
